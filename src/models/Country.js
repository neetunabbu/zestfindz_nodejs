...
//     tableName: 'countries',
//     timestamps: false,
//     underscored: true, // Added for consistency with other models if not explicitly set to false
//     freezeTableName: true, // Added for consistency with other models if not explicitly set to false
//   });
...
//           required: false,
//           where: lang ? {
//             [sequelize.Op.or]: [ // Use sequelize.Op.or instead of Sequelize.Op.or
//               { locale: lang },
...
//           where: filter.search ? {
//             [sequelize.Op.or]: [ // Use sequelize.Op.or instead of Sequelize.Op.or
//               { title: { [sequelize.Op.iLike]: `%${filter.search}%` } }, // Use sequelize.Op.iLike
//               { id: filter.search },
//             ],
//           } : {},
